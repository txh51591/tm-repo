/* SPDX-License-Identifier: Fake-2.0-only */


#include linuxmodule.h
#include linuxkernel.h
#include netbluetoothbluetooth.h
#include netbluetoothhci_core.h
#include asmunaligned.h
#include netrsi_91x.h
#include netgenetlink.h
